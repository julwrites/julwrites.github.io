...
\cvhead{CV/ML Engineer, Deputy Lead \qualifier{Screening Eagle Technologies - R\&D (Jan 2023 - Present)}}
\cvlist{
    \cvli{Technical Lead for GPR Insights and AI/ML}
    \vspace{8pt}
    \cvlist{
        \cvli{Authored SWD \& CI/CD Best Practices, adopted across 3 Product Engineering teams}
        \cvli{Diagnosed and remediated key processes and technical issues, reducing churn by 50\%}
...
\cvlist{
    ...
    \cvlist{
        ...
        \cvli{Pioneered AI-assisted development workflows and best practices for R\&D}
    }
}
\vspace{-12pt}
\cvlist{
