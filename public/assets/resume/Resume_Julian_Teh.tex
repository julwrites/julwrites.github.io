...
\cvcols{
    \cvhead{Skills}
    \cvlist{
        \cvli{C/C$_{++}$, Python, Javascript/Typescript, Go}
...
\cvhead{Screening Eagle Technologies \qualifier{C++ CV/ML Software Engineer (Dec 2020 - Present)}}
\cvlist{
    \cvli{Software Engineer for \textit{Special Projects Team}}
}
