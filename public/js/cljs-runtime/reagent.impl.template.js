...
var G__6379 = o;
(G__6379[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__6381 = o;
(G__6381[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__6384 = props;
var G__6384__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6384,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__6384);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6384__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__6387){
...
var props = map__6388__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6388__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__6388,map__6388__$1,props,class$){
return (function (c){
...
});})(map__6388,map__6388__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__6391){
var map__6392 = p__6391;
var map__6392__$1 = (((((!((map__6392 == null))))?(((((map__6392.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6392.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6392):map__6392);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6392__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__6392,map__6392__$1,on_write){
return (function (){
...
});})(node_value,map__6392,map__6392__$1,on_write))
);
} else {
...
var G__6395 = jsprops;
(G__6395["defaultValue"] = value);

(G__6395["onChange"] = ((function (G__6395,v,value,on_change){
return (function (p1__6394_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__6394_SHARP_);
});})(G__6395,v,value,on_change))
);
...
var vec__6397 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6397,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6397,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6397,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___6437 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___6437 == null)){
} else {
var key_6438 = temp__5724__auto___6437;
(jsprops["key"] = key_6438);
}
...
var temp__5724__auto___6439 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___6439 == null)){
} else {
var key_6440 = temp__5724__auto___6439;
reagent.impl.template.oset(jsprops,"key",key_6440);
}
...
var G__6401 = reagent.impl.template.__GT_NativeWrapper();
(G__6401["name"] = c);
...
var G__6402 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__6402) : reagent.impl.template.as_element.call(null,G__6402));
} else {
...
var len__4730__auto___6472 = arguments.length;
var i__4731__auto___6473 = (0);
while(true){
if((i__4731__auto___6473 < len__4730__auto___6472)){
args__4736__auto__.push((arguments[i__4731__auto___6473]));

var G__6475 = (i__4731__auto___6473 + (1));
i__4731__auto___6473 = G__6475;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq6405){
var G__6406 = cljs.core.first(seq6405);
var seq6405__$1 = cljs.core.next(seq6405);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6406,seq6405__$1);
});
...
break;
default:
var G__6482 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__6482;
continue;
...
var n__4607__auto___6489 = a.length;
var i_6490 = (0);
while(true){
if((i_6490 < n__4607__auto___6489)){
(a[i_6490] = reagent.impl.template.as_element((a[i_6490])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___6492 = a.length;
var i_6493 = (0);
while(true){
if((i_6493 < n__4607__auto___6492)){
var val_6494 = (a[i_6493]);
if(((cljs.core.vector_QMARK_(val_6494)) && ((reagent.impl.template.key_from_vec(val_6494) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_6493] = reagent.impl.template.as_element(val_6494));
...
var ctx = ({});
var vec__6409 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6409,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6409,(1),null);
...
var G__6412 = (cljs.core.count(argv) - first_child);
switch (G__6412) {
case (0):
...
var G__6413 = comp;
var G__6414 = jsprops;
var G__6415 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__6413,G__6414,G__6415);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__6412){
