...
if((i < len)){
var k = (ks[i]);
var G__6372 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__6373 = (i + (1));
m = G__6372;
i = G__6373;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__6260 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__6260);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__6262 = c;
var G__6262__$1 = (((G__6262 == null))?null:G__6262.prototype);
if((G__6262__$1 == null)){
return null;
} else {
return (G__6262__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__6268 = c;
var G__6268__$1 = (((G__6268 == null))?null:G__6268.prototype);
if((G__6268__$1 == null)){
return null;
} else {
return (G__6268__$1["render"]);
}
})() == null)))));
});
...
var G__6278 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__6278) : reagent.impl.component.as_element.call(null,G__6278));
};
var G__6375 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__6376__i = 0, G__6376__a = new Array(arguments.length -  0);
while (G__6376__i < G__6376__a.length) {G__6376__a[G__6376__i] = arguments[G__6376__i + 0]; ++G__6376__i;}
  args = new cljs.core.IndexedSeq(G__6376__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__6279 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__6280 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__6280;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__6279;
}});
...
var G__6281 = key;
var G__6281__$1 = (((G__6281 instanceof cljs.core.Keyword))?G__6281.fqn:null);
switch (G__6281__$1) {
...
return ((function (G__6281,G__6281__$1){
...
var c = this;
var G__6286_6382 = (c["cljsRatom"]);
if((G__6286_6382 == null)){
} else {
reagent.ratom.dispose_BANG_(G__6286_6382);
}
...
var renders_6385 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_6386 = cljs.core.first(cljs.core.vals(renders_6385));
if((cljs.core.count(renders_6385) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_6385))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_6386)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_6386], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__6320 = name;
switch (G__6320) {
case "":
...
var G__6322 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__6322);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__6323 = fiber;
var G__6323__$1 = (((G__6323 == null))?null:(G__6323["type"]));
if((G__6323__$1 == null)){
return null;
} else {
return (G__6323__$1["displayName"]);
}
})();
var parent = (function (){var G__6324 = fiber;
if((G__6324 == null)){
return null;
} else {
return (G__6324["return"]);
}
})();
var path = (function (){var G__6325 = parent;
var G__6325__$1 = (((G__6325 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__6325) : reagent.impl.component.fiber_component_path.call(null,G__6325)));
if((G__6325__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6325__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__6338 = c;
if((G__6338 == null)){
return null;
} else {
return (G__6338["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__6344._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__6351 = c;
if((G__6351 == null)){
return null;
} else {
return (G__6351["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__6353 = c;
if((G__6353 == null)){
return null;
} else {
return G__6353._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__6356 = instance;
if((G__6356 == null)){
return null;
} else {
return (G__6356["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__6357 = instance;
if((G__6357 == null)){
return null;
} else {
return G__6357._currentElement;
}
}
})();
var name = (function (){var G__6359 = elem;
var G__6359__$1 = (((G__6359 == null))?null:(G__6359["type"]));
if((G__6359__$1 == null)){
return null;
} else {
return (G__6359__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__6361 = elem;
if((G__6361 == null)){
return null;
} else {
return (G__6361["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__6362._owner;
}
}
})();
var path = (function (){var G__6363 = owner;
var G__6363__$1 = (((G__6363 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__6363) : reagent.impl.component.component_path.call(null,G__6363)));
if((G__6363__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6363__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__6364 = c;
var G__6364__$1 = (((G__6364 == null))?null:G__6364.constructor);
if((G__6364__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__6364__$1);
}
}
})();
