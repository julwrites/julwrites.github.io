...
var $author$project$Main$Viewport = function (a) {
	return {$: 'Viewport', a: a};
};
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			...
			A2($elm$core$Task$perform, $author$project$Main$Viewport, $elm$browser$Browser$Dom$getViewport));
	});
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onResize(
		F2(
			function (w, h) {
				return A2($author$project$Main$OnWindowResize, w, h);
			}));
};
...
var $author$project$Main$siteTheme = {
	backgroundColor: A3($mdgriffith$elm_ui$Element$rgb255, 34, 44, 60),
	borderColor: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
	contentSpacing: 30,
	disabledFontColor: A3($mdgriffith$elm_ui$Element$rgb255, 128, 128, 128),
	fontColor: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255),
...
var $author$project$Main$intro = A2(
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('Hi, I\'m Julian')),
			A2(
			...
			$mdgriffith$elm_ui$Element$text('Welcome to my domain'))
		]));
			...
			attrs,
			{
				label: A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$width(
							$mdgriffith$elm_ui$Element$px(33)),
							$mdgriffith$elm_ui$Element$height(
							$mdgriffith$elm_ui$Element$px(33))
						]),
					{description: def.description, src: def.src}),
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color($author$project$Main$siteTheme.backgroundColor),
						$mdgriffith$elm_ui$Element$Font$color($author$project$Main$siteTheme.fontColor),
						$mdgriffith$elm_ui$Element$Font$family($author$project$Main$siteTheme.fontFamily),
						$mdgriffith$elm_ui$Element$padding($author$project$Main$siteTheme.padding)
					]),
				$author$project$Main$dom)
			]),
		title: 'tehj.io'
	};
};
